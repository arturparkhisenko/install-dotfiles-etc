...
html5/css3, css4, html5-boilerplate, bootstrap
    CSS methodology
...
Каналы для просмотра и следования (sorax, addi, paul, uwebpodcast, hexlet, loftblog and etc.)
...
SVG: http://ask.dev.cpeople.ru/pres/svg/
